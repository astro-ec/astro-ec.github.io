...
export const footerData = {
  ...
  footNote: `
    <img class="w-5 h-5 md:w-6 md:h-6 md:-mt-0.5 bg-cover mr-1.5 rtl:mr-0 rtl:ml-1.5 float-left rtl:float-right rounded-sm" src="~/src/assets/images/nwlg.png" alt="OEAA logo" loading="lazy"></img>
